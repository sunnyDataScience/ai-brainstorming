...
> Date: 2026-04-08
> Codebase: shared Next.js app with `ideacheck.cc` (lite variant)
...
## 站點觀察（unique to this clone）

> shipyouridea.today is the "lite" variant of ideacheck.cc — same codebase, fewer sections, simplified nav. This is a real-world example of one-codebase brand A/B testing. The KEEP/DROP decisions here must consider whether you're cloning the lite (demo-first) or full (trust-first) narrative.
